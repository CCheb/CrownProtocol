...
public partial class UserNpm : Control
{
	...
	{
		return GenericCore.Instance.connectedPeers.ContainsKey(myNetID.OwnerId);
	}
	...
	{
		userNameLabel.Text = GenericCore.Instance.connectedPeers[myNetID.OwnerId]["UserName"];
	}
	...
	private void RequestReadyUp(bool toggledOn)
	{
		if(GenericCore.Instance.IsServer)
		{
			...
			EmitSignalReadyUpToggled();	// GameLobby looks for this
		}
	}
}
